...
birds.push(bird2);
birds.push(bird );
    //log6 = new Log(230,180bird2=new Bird(150,170);,80, PI/2);
...
function mouseDragged(){
    ...
    function keyPressed(){
         if((keyCode === 32) && gameState ==="launched"){ if(birds.length>=0 )
            { Matter.Body.setPosition(birds[birds.length-1].body, {x: 200 , y: 50});
             slingshot.attach(birds[birds.length-1].body); gameState = "onSling"; 
            }
         }
         }
